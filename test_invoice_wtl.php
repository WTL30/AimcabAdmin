...
<body>
    <div class="container">
        <div class="row">
            <div class="col-xs-4">
                <img src="' . $img . '" height="70px" width="90px" alt="logo">
            </div>
            <div class="col-xs-4">
            <p>&emsp;</p>
                <p>&emsp;</p>
            ...
            <div class="col-xs-7">
                <table class="table2">
                   ...
                   if($toll!= 0){
                    ...
                    if($parking!= 0){
                            $html .= '<tr>
                        <td style="background-color: white;"><strong>Sub Total:</strong></td>
                        <td style="background-color: white;">Rs.'.$subTotal.'</td>
                    </tr>';
                    }
