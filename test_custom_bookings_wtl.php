            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    include "config.php";
                   	$value2='';
                   	$numericPart=0;
                    // Create a unique book ID using timestamp and random component
                    $currentTime = time();
                    $randomComponent = mt_rand(1000, 9999); // Adjust the range as needed
                    $value2 = "WTL" . $currentTime . "A" . sprintf('%04d', $numericPart + $randomComponent);
                    $value = $value2; 
             ...
             <div class="rental">
                <form id="form" action="test_invoice_redirect_wtl.php" Method="POST" target="_blank">
