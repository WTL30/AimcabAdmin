...
if (isset($_POST['submit_trip'])) {
    ...
    // Step 2: Get the last id from oneway_trip table
    $getLastIdQuery = "SELECT MAX(id) AS last_id FROM oneway_trip";
    ...
    // Step 3: Insert trip details using the new id
    $sql = "INSERT INTO `oneway_trip` (id, source_state, source_city, destination_state, destination_city, hatchback, sedan, SedanPremium, suv, suvplus) 
            VALUES ('$newId', '$sourceState', '$sourceCity', '$destState', '$destCity', '$hatchback', '$sedan', $sedanPremium, '$suv', '$suvPlus')";
...
?>
                        ...
                        <form action="add-oneway-tripWTL.php" method="POST">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-sm-4">
