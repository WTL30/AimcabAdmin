            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        include "config.php";
                        $value2 = '';
                        $query = "SELECT bookid FROM custom_booking WHERE bookid LIKE 'WTL%' ORDER BY id DESC LIMIT 1;";
                        $stmt = $link->query($query);
                        if (mysqli_num_rows($stmt) > 0) {
                            // Fetch the last inserted bookid
                            if ($row = mysqli_fetch_assoc($stmt)) {
                                $value2 = $row['bookid'];
                                if (preg_match('/^WTL1000(\d+)$/', $value2, $matches)) {
                                    $numericPart = (int) $matches[1];
                                    $numericPart++;
                                    $value2 = "WTL1000" . sprintf('%01d', $numericPart);
                                } else {
                                    $value2 = "WTL10001";
                                }
                            }
                        ...
                        <div class="nogstselect">
                            <div class="col-md-4 p-2">
                                <h4><strong>
                                        <div class="text-dark my-1"><i class="mr-2 menu-icon fa fa-car"></i> Trip Type </div>
                                    </strong></h4>
                        ...
                        <div class="rental">
                            <form id="form" action="invoice-redirect-wtl.php" Method="POST" target="_blank">
                                <div class="row p-2 my-1">
                                    <div class="col-lg-4"><br>
                                        <h4><strong>
                                                <div class="text-dark my-1 ">Choose Date and Time</div>
                                            </strong></h4>
                                        ...
                                        <strong class="label label-default">company name :</strong>
                                        <input id="companyname" class="form-control register_form  " name="companyname" type="text" placeholder="company name" required><br>
                                        <strong class="label label-default">company address :</strong>
                                        <input id="companyaddress" class="form-control register_form  " name="companyaddress" type="text" placeholder="company address" required><br>
                                        <input id="bookid" class="form-control register_form " name="bookid" type="hidden" value="<?php echo $value; ?>">
                                    ...
                                    <div class="col-lg-4"><br>
                                        ...
                                        <strong class="label label-default">GST NO :</strong>
                                        <input id="gstno" class="form-control register_form  " name="gstno" type="text" placeholder="GST NO." required><br>
                                    </div>
                                    <div class="col-lg-4"><br>
                                        ...
                                        <h4><strong>
                                                <div class="text-dark my-1"> Fixed KM </div>
                                            </strong></h4>
            ...
            <form id="form" action="invoice-redirect-wtl.php" Method="POST" target="_blank">
                ...
                <div class="row p-2 my-1">
                    <div class="col-lg-4"><br>
                        ...
                        <h4><strong>
                                <div class="text-dark my-1 ">Choose Start Trip Date and Time</div>
                            </strong></h4>
                        <input class="col-7" class="form-control register_form " name="date" type="date" placeholder="Date"><br><br>
                        <input class="col-6" class="form-control register_form " name="time" type="time" placeholder="Time"><br><br>
                        <h4><strong>
                                <div class="text-dark my-1 ">Choose End Trip Date and Time</div>
                            </strong></h4>
