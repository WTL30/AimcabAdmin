...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex">
                <a href="updatetripWTL.php" class="btn btn-secondary btn-sm">Oneway Prices</a>
                <a href="update-trip-roundWTL.php" class="btn btn-secondary btn-sm">Round Prices</a>
                <a href="update-trip-rentalWTL.php" class="btn btn-secondary btn-sm">Rental Prices</a>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="rental" class="btn btn-success">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
