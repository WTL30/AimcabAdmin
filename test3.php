...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex">
                <a href="update-trip.php" class="btn btn-warning btn-lg">Oneway Prices</a>
                <a href="update-trip-round.php" class="btn btn-primary btn-lg">Round Prices</a>
                <a href="update-trip-rental.php" class="btn btn-danger btn-lg">Rental Prices</a>
            </div>
        </div>
    </div>
</div>
...
//added this for displaying distance 
