...
// Mail to Customer
// ||$tripType == 'oneWay'
if($tripType == 'One Way' || $tripType == 'one way' ||$tripType == 'oneWay'){
$to = $custMail;
            ...
            <div style='padding:50px;'>
                <p>Dear $custName,<br>
                  <p>Upadated your travel information for booking id $bookingId. Please see the updated trip details below. </p>
                         ...
                         <strong>Assigned Vahicle Number - $rcNo </strong><br>
...
//mail to customer
if($tripType == 'Round' || $tripType == 'round' || $tripType == 'roundTrip'){
$to = $custMail;
$subject = "Your journey information has been updated.";
            ...
            <div style='padding:50px;'>
                <p>Dear $custName,<br>
                  <p>Upadated your travel information for booking id $bookingId. Please see the updated trip details below. </p>
                         ...
                         <strong>Vahicle Category - $vName </strong><br>
                         <strong>Vahicle Number -  $rcNo </strong><br>
