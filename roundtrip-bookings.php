...
<?php include 'header.php';?>
  <body> 
       ...
       <li class="menu-item-has-children dropdown" >
                        <a href="bookings.php" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Round Trip Bookings</a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Round-Trip Bookings Table</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table-stats order-table ov-h table table-striped table-bordered">
                                    ...
                                    <?php
                                      include 'config.php';
                                       $pic = mysqli_query($link,"SELECT * FROM `user_booking` WHERE user_trip_type='Round' ORDER BY `id` DESC");
