...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex">
                <a href="update-trip.php" class="btn btn-secondary btn-sm">Oneway Prices</a>
                <a href="update-trip-round.php" class="btn btn-secondary btn-sm">Round Prices</a>
                <a href="update-trip-rental.php" class="btn btn-secondary btn-sm">Rental Prices</a>
            </div>
        </div>
    </div>
</div>
